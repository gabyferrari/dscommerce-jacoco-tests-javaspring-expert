...
public class UserServiceTests {
	...
	void setUp() throws Exception {
		...
		user = UserFactory.customAdminUser(1L, existingUsername);
		userDetails = UserDetailsFactory.customAdminUser(existingUsername);
	...
	public void getMeShouldReturnUserDTOWhenUserExists() {	
		//Mockito.doReturn(user).when(service).authenticated(); erro
